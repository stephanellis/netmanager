...
def main(global_config, **settings):
    ...
    config.add_route('snfilterlist', '/snfilterlist')
    config.add_route('snfilterlist_add', '/snfilterlist/add')
    config.add_route('snfilterlist_del', '/snfilterlist/del/{name}')
    config.add_route('snfilterlist_save', '/snfilterlist/save/{name}')
    config.scan()
